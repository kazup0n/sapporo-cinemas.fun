...
var _cinema_schdule = __webpack_require__(69);

var _cinema_view = __webpack_require__(72);

var _cinema_view2 = _interopRequireDefault(_cinema_view);
...
function mapDispatchToPropsContainer(dispatch) {
  return {
    onDateChange: function onDateChange(date) {
      return dispatch((0, _cinema_schdule.fetchCinemaSchedules)(date));
    }
  };
}

var App = (0, _reactRedux.connect)(mapStateToPropsContainer, mapDispatchToPropsContainer)(_cinema_view2.default);

var store = (0, _redux.createStore)(_cinema_schdule.cinemasSchedules, (0, _redux.applyMiddleware)(_reduxThunk2.default));
...
exports.cinemasSchedules = cinemasSchedules;
exports.fetchCinemaSchedules = fetchCinemaSchedules;
...
var SET_SCHEDULES = 'SET_SCHEDULES';
...
function fetchCinemaSchedules(date) {
  return function (dispatch, getState) {
    if (!getState().allSchedules) {
      (0, _isomorphicFetch2.default)('cinema_schedules.json').then(function (response) {
        response.json().then(function (allSchedules) {
          var schedules = allSchedules[date];
          dispatch(setSchedules(date, schedules, allSchedules));
        });
      });
    } else {
      var allSchedules = getState().allSchedules;
      var schedules = allSchedules[date];
      dispatch(setSchedules(date, schedules, allSchedules));
    }
  };
...
var _cinema_schedules = __webpack_require__(73);

var _cinema_schedules2 = _interopRequireDefault(_cinema_schedules);

var _date_picker = __webpack_require__(74);
...
exports.default = function (props) {
  return _react2.default.createElement(
    'div',
    null,
    _react2.default.createElement(_date_picker2.default, { onDateChange: props.onDateChange }),
    _react2.default.createElement(_cinema_schedules2.default, { schedules: props.schedules })
  );
};
...
var TimeList = function TimeList(props) {
  var schedules = props.schedules.map(function (s) {
    return _react2.default.createElement(
      'li',
      { key: s[0] + '-' + s[1] },
      s[0],
...
var CinemaRow = function CinemaRow(props) {
  var _props$cinema = props.cinema,
      title = _props$cinema.title,
      theater = _props$cinema.theater,
      schedules = _props$cinema.schedules;

  var link = 'https://www.google.co.jp/search?q=' + title;
  return _react2.default.createElement(
    'tr',
    null,
    ...
    _react2.default.createElement(
      'td',
      null,
      _react2.default.createElement(TimeList, { schedules: schedules })
    )
  );
};

exports.default = function (props) {
  var rows = props.schedules.map(function (s) {
    return _react2.default.createElement(CinemaRow, { key: s.title, cinema: s });
  });

  return _react2.default.createElement(
    'table',
    { className: 'table table-striped table-responsive table-sm' },
    _react2.default.createElement(
      'thead',
      null,
      _react2.default.createElement(
...
exports.default = function (props) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement("input", { type: "date", className: "form-control", onChange: onDateChange })
    )
  );
};
